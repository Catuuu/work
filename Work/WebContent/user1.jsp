...
<script type="text/javascript">
	...
	function add1(){
		...
		var courseId=document.getElementById("jscourse").value;
...
<body class="easyui-layout">
	...
	<div id="w5" iconCls="icon-search" title="查询" align="center" style="overflow:hidden">
	         <input id="sear"/><input type="hidden" id="pin" value=""><a href="javascript:doPrintNew()" id="xls" plain="true"  iconCls="icon-print">导出xls</a>  	
	         <table id="ta6"></table>
	</div>
 ...
 %>
	...
	<div id="w9" iconCls="icon-save" title="班级添加">
	             ...
	             班级编号：<input class="easyui-validatebox" type="text" id="bjsid" name="sid" required="true"><br/>
	...
	<div id="w11" iconCls="icon-save" title="教师添加">
	             ...
	             教授课程：<input class="easyui-validatebox" type="text" id="jscourse" name="sid" required="true"><br/>	
	             <div align="center">           
	...
	<div id="w12" iconCls="icon-save" title="教师修改">
	             ...
	             教授课程：<input class="easyui-validatebox" type="text" id="jscourseed" name="sid" required="true"><br/>
	...
	<div id="w15" iconCls="icon-save" title="课程添加">
	             课程编号：<input class="easyui-validatebox" type="text" id="kccid" name="jsname" required="true"><br/>
	             ...
	             所属班级：<input class="easyui-validatebox" type="text" id="kcsid" name="jsphone" required="true"><br/>
	             <div align="center">           
	...
	<div id="w16" iconCls="icon-save" title="课程修改">
	             ...
	             所属班级：<input class="easyui-validatebox" type="text" id="kcsided" name="jsphone" required="true"><br/>
