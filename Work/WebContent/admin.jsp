...
<body class="easyui-layout">
	...
	<div align="center">
	    <div class="toolbar">
	    <a  class="easyui-linkbutton" iconCls="icon-ok" plain="true" onclick="javascript:showTu()">统计图表</a><br/>
		<a  class="easyui-linkbutton" iconCls="icon-ok" plain="true" onclick="javascript:showPro()">立即排课</a><br/>
		<a  class="easyui-linkbutton" iconCls="icon-ok" plain="true" onclick="javascript:doClean()">清除排课结果</a><br/>
	...
	<div region="west" title="选择栏"
		...
		<div class="easyui-accordion" fit="true" border="false">
		    <div title="管理部分" iconCls="icon-ok" style="padding: 10px;">
			<table>
				<tr>
					<td><a href="javascript:addTab()"><img alt=""
							src="images/b1.jpg" border="0"></a></td>
				</tr>
				<tr>
					<td><a href="javascript:addTab1()"><img alt=""
							src="images/b2.jpg" border="0"></a></td>
				</tr>
				<tr>
					<td><a href="javascript:addTab2()"><img alt=""
							src="images/b3.jpg" border="0"></a></td>
				</tr>
			</table>
		</div>
		<div title="排课管理" iconCls="icon-ok"
			...
			<table>
			    <tr>
					<td><a href="javascript:addTab3()"><img alt=""
							src="images/b5.jpg" border="0"></a></td>
				</tr>
				<tr>
		...
		<div title="手动功能" iconCls="icon-ok"
			style="overflow: hidden; padding: 10px;">
			<table>
				<tr>
					<td><a href="javascript:addTab5()"><img alt=""
							src="images/b11.jpg" border="0"></a></td>
				</tr>
			</table>
		</div>
		<div title="权限管理" iconCls="icon-ok"
			style="overflow: hidden; padding: 10px;">
			<table>
				<tr>
					<td><a href="javascript:addTab8()"><img alt=""
							src="images/b8.jpg" border="0"></a></td>
				</tr>
				<tr>
					<td><a href="javascript:doWindow9()"><img alt=""
							src="images/b9.jpg" border="0"></a></td>
				</tr>
			</table>
		</div>
		</div>
 ...
 %>
	...
	<div id="mm" class="easyui-menu" style="width:120px;">
     	<div onclick="javascript:showTu()">统计图表</div>
