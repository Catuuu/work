...
import com.opensdk.meituan.vo.PoiTagParam;
...
public class PoiAPI extends API{
     ...
     * @return
     */
    public String poiSave(SystemParamMeituan systemParam , PoiParam poiParam) throws ApiOpException,
            ApiSysException {
     ...
     * @return
     */
    public String poiGetIds(SystemParamMeituan systemParam) throws ApiOpException, ApiSysException {
     ...
     * @return
     */
    public List<PoiParam> poiMget(SystemParamMeituan systemParam, String appPoiCodes) throws ApiOpException,
                                                                                    ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     * @return
     */
    public String poiOpen(SystemParamMeituan systemParam, String appPoiCode) throws ApiOpException,
                                                                                     ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     * @return
     */
    public String poiClose(SystemParamMeituan systemParam, String appPoiCode) throws ApiOpException,
                                                                                    ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     * @return
     */
    public String poiOnline(SystemParamMeituan systemParam, String appPoiCode) throws ApiOpException,
                                                                                     ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     * @return
     */
    public String poiOffline(SystemParamMeituan systemParam, String appPoiCode, String reason) throws ApiOpException,
                                                                                      ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     * @return
     */
    public String poiQualifySave(SystemParamMeituan systemParam, String appPoiCode, PoiQualificationEnum poiQualificationEnum,
     ...
     * @return
     */
    public String poiSendTimeSave(SystemParamMeituan systemParam, String appPoiCodes, int sendTime)
        throws ApiOpException, ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     * @return
     */
    public String poiAdditionalSave(SystemParamMeituan systemParam, String appPoiCode, String appPoiEmail,
     ...
     * @return
     */
    public String poiUpdatePromotionInfo(SystemParamMeituan systemParam, String appPoiCode, String promotionInfo)
        throws ApiOpException, ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     * @return
     */
    public List<PoiTagParam> poiTagList(SystemParamMeituan systemParam) throws ApiOpException, ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     */
    public String poiUpdateShippingtime(SystemParamMeituan systemParam, String appPoiCode, String shippingTime)
            throws ApiOpException, ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     * @throws ApiSysException
     */
    public String poiIsDelayPushLogistics(SystemParamMeituan systemParam, String appPoiCode)
            throws ApiOpException, ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     * @throws ApiSysException
     */
    public String poiSetDelayPushLogistics(SystemParamMeituan systemParam, String appPoiCode, int delaySeconds)
            throws ApiOpException, ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     * @throws ApiSysException
     */
    public String poiComment(SystemParamMeituan systemParam, String appPoiCode, int startTime, int endTime, int pageoffset, int pagesize)
            throws ApiOpException, ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
