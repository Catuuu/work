...
public class ConvertUtil {
     ...
     * @return
     */
    public static Map<String,String> convertSystemParamsToMap(SystemParamEleme systemParam){
        Map<String,String> resultMap = new HashMap<String, String>();
        resultMap.put("timestamp",String.valueOf(System.currentTimeMillis() / 1000));
        resultMap.put("consumer_key",systemParam.getConsumer_key());
        //resultMap.put("consumer_secret",systemParam.getConsumer_secret());
        return resultMap;
    }
