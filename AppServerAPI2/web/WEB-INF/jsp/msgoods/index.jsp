...
<head>
    ...
    <script type="text/javascript">
        var apiPath = 'http://erp.caidashi.pro/';
        ...
        $(function () {
            ...
            $('#List').datagrid({
                ...
                onAfterEdit:function (rowIndex, rowData, changes) {
                    if(changes.good_price==undefined){
                        return false;
                    }
                    $.ajax({
                        url: "/MsGoods/updateErpCount",
                        data: {good_id: rowData.good_id,
                            good_price:changes.good_price,
                            out_time:changes.out_time,
                            finished_weight:changes.finished_weight,
                        },
                        type: 'POST',
                ...
                columns:[[
                    ...
                    {field:'good_name',title:'商品名称',width:'20%',align: 'center',sortable:true},
                    {field:'class_id',title:'商品类别',width:'10%',sortable:true,align: 'center',formatter:function(value,row){
                    ...
                    {field:'isback',title:'备餐',width:'7%',align: 'center',formatter:function(value,row){
                        if (value == 1) {
                    ...
                    { field: 'good_price', title: '销售价格', width: '10%', align: 'center',
                    ...
                    { field: 'out_time', title: '出餐时间(分钟)', width: '10%', align: 'center',
...
//                                precision: 2
                    ...
                    { field: 'finished_weight', title: '成品重量(克)', width: '10%', align: 'center',
                        styler: function(value,row,index){return 'color:green;cursor:pointer'},
                        editor: {
                            type: 'numberbox',
                            options: {
...
//                                precision: 2
                    ...
                    {field:'counts',title:'材料数量',width:'8%',align: 'center',sortable:true,formatter:function(value,row){
//                        if (value == 1) {
//                            return '<span onclick="toggle('+row.good_id+',2)" style="color:green;cursor:pointer">是</span>';
//                        } else {
//                            return '<span onclick="toggle('+row.good_id+',2)" style="color:red;cursor:pointer">否</span>';
...
//            }
        ...
        function saveprint(){
            var good_name = $("#check_name").val();
            var class_id = $("#check_class").combobox('getValue');
            $.ajax({
                url: "/MsGoods/checkName",
...
<div class="easyui-layout" style="width:100%;height:100%;">
    ...
    <div data-options="region:'center',iconCls:'icon-tip'" style="height:100%;width:30%;">
...
<div id="dlg2" class="easyui-dialog" style="width: 60%; height: 80%; padding: 10px 20px;"
    ...
    <form id="fm2" method="post">
        <div class="fitem">
            ...
            <select class="easyui-combobox easyui-validatebox" name="class_id" required="true" style="width: 160px;" id="check_class">
        ...
        <div class="fitem">
            ...
            <input name="good_name" class="easyui-textbox easyui-validatebox" required="true" id="check_name"/>
        </div>
        <div class="fitem">
        ...
        <div class="fitem">
            <table>
                <tr>
                    ...
                    <td style="line-height: 20px;padding-left: 40px;text-align: center;"><input name="isback" type="radio" value="0" onclick=sfbc('a','0') checked="true" /><span onclick=sfbc('a','0') style="cursor:pointer;">否</span></td>
                </tr>
            </table>
