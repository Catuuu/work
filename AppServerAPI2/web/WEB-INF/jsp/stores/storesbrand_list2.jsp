                    ...
                    [
                        {
                            ...
                            formatter: function (value, row) {
                                ...
                                return '<a href="javascript:void(0)" onclick="bind(' + id + ',1)" style="text-decoration:none;color: green" name="' + id + '">加载中...</a>';
                            }
                        },
                        {
                            field: 'elem_mode',
...
//            $("a [name='"+id2+"']").css("backgroundColor", "#C0C0C0");
        ...
        //查询饿了么绑定信息
        function elestoresBindQuery(id, bdid) {
            $.ajax({
                url: "/Stores/elestoresBindQuery",
                data: {stores_brand_id: id},
                type: 'POST',
