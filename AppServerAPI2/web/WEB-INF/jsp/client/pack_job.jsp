    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#downLoad").click(function () {
                ...
                $("#downLoad").exprotAjaxExcel("/packApi/packJobExcel",paramData);
            });
        ...
        function getdata() {
            ...
            var endday = $("#endday").val();
            var paramData = {'startday': startday, 'endday': endday, 'ordertype': ordertype, 'datatype': datatype};
            $.postJSON("/packApi/packJob", paramData, function (data) {
                $('#tableList').datagrid({
                    iconCls: 'icon-save',
                    fitColumns:false,
                    rownumbers: true,//行号
                    ...
                    frozenColumns:[
                        [
                            {"field":"order_date","title":"日期","width":180,"align":"center"},
                            {"field":"count1","title":"合计","width":180,"align":"center"}
                        ]
                    ],
...
<div class="bodymain">
    <div class="htitle">
        <div class="title"><h2>打包计件</h2></div>
